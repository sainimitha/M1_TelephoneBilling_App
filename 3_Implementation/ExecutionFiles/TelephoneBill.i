...
void deleterecords()
{
 ...
 int i=1;
 char phonenumber[20];
 if((t=fopen("c:/temp.ojs","w+"))==
# 12 "deleterecords.c" 3 4
                                  ((void *)0)
# 12 "deleterecords.c"
                                      )
 exit(0);
 if((f=fopen("c:/file.ojs","rb"))==
# 14 "deleterecords.c" 3 4
                                  ((void *)0)
# 14 "deleterecords.c"
                                      )
 exit(0);
